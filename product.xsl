...
<body>
    <table width="100%" border="1" style="border-collapse: collapse">
        <tr>
            ...
            <td width="5%" bgcolor="black"><font face="MS Sans Serif" size="2" color="white"><b>รายชื่อ</b></font></td>
            <td width="5%" bgcolor="black"><font face="MS Sans Serif" size="2" color="white"><b>รายละเอียด</b></font></td>
